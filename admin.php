            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" name="upload_portfolio" id="upload_portfolio" enctype="multipart/form-data" action="upload.php">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 text-left">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <span class="btn btn-primary btn-file">
                                                       Add Album Cover&hellip; <input type="file" name="album_cover">
                                                    </span>
                                                </span>
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <span class="btn btn-primary btn-file">
                                                       Add Photos&hellip; <input type="file" name="album_photos" multiple>
                                                    </span>
                                                </span>
                                                <input type="text" class="form-control" readonly>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 text-left">
                                            ...
                                            <button type="submit" class="btn btn-xl">Upload!</button>
                                        </div>
